...
vim.keymap.set('v', 's', 'y:Telescope current_buffer_fuzzy_find default_text=<C-r>"<CR>',
  { desc = '[s]earch [s]election' })
vim.keymap.set('v', 'S', 'y:Telescope live_grep default_text=<C-r>"<CR>', { desc = '[s]earch [s]election' })
vim.keymap.set('n', '<leader>ss', 'yiw:Telescope current_buffer_fuzzy_find default_text=<C-r>"<CR>',
  { desc = '[s]earch [s]election' })
vim.keymap.set('n', '<leader>sS', 'yiw:Telescope live_grep_args default_text=<C-r>"<CR>',
  { desc = '[s]earch [s]election' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'cpp', 'go', 'lua', 'ruby', 'elixir', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'glsl' },
